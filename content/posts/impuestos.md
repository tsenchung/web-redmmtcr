...
Así se ha establecido tanto en la ley como en el discurso público [Nota al pie: El código tributario de Costa Rica define los tributos como "las prestaciones en dinero (impuestos, tasas y contribuciones especiales), que el Estado, en ejercicio de su poder de imperio, exige con el objeto de obtener recursos para el cumplimiento de sus fines" y define impuesto como "el tributo cuya obligación tiene como hecho generador una situación independiente de toda actividad estatal relativa al contribuyente". http://www.pgrweb.go.cr/SCIJ/Busqueda/Normativa/Normas/nrm_texto_completo.aspx?nValor1=1&nValor2=6530].
...
[^1]: [La deuda pública y los dólares del FMI]({{< ref "deuda-publica-dolares-fmi.md" >}})
